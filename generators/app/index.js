...
const { xfs, newProjectPath, npmInstall, message } = require('../../lib/utils')
...
module.exports = (props) => {
  ...
  fs.access(generatorRootPath, fs.F_OK, function (err) {
    if (!err) {
      ...
      exec('mkdir', ['-p', generatorRootPath])
      // TODO: Use windows support for recursive directory make
      genesis()
    }
  })
  ...
  function genesis () {
    ...
    exec('git', ['clone', '-q', repo, generatorRootPath], {}, function () {
      // compile template
